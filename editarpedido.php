...
?>
    ...
    <div class="container">
        ...
        <?php endif; ?>
            ...
            $id = $_GET['id'] ?? null;
                ...
                $sql = "SELECT * FROM pedidos WHERE cve_pedido = ?";
    ...
    $sql = "UPDATE pedidos SET piezas_cve_pieza = ?, clientes_id_cte = ?, cantidad_piezas = ?, fecha_recibido = ?, fecha_entrega = ?, Precio_final = ? WHERE cve_pedido = ?";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([$tipo, $cliente, $piezas, $fecharecibido, $fechaentrega, $Preciofinal, $id]);
